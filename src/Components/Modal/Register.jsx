...
toast.configure()
const Register = ({ shouldShows, Code, close }) => {
    ...
    const headingChange = () => {
        if (index === 0) {
                ...
                <>
                    <div className="text-center" style={{ marginTop: '2em' }}>
                        ...
                        <p className="me-3 ms-3">
                            Welcome to PL Share, <br /> a platform where you can earn up to 50k in a
                            month easily! <br />  Enter the refer code below to register yourself and get started ...
                        </p>
                    </div>
                </>
            )
            ...
            return (
                <>
                    <div className="text-center" style={{ marginTop: '0em' }}>
                        <h1>Verification</h1>
                        <p className="me-3 ms-3">
                ...
                <>
                    <div className="text-center" style={{ marginTop: '0em' }}>
                        ...
                        <p className="me-3 ms-3 text-center">
                            Please fill the following details to get registered on PL Share
                        </p>
                    </div>
                </>
            )
    ...
    return (
        <div>
            <Modal open={shouldShows} >
                <div>

                    <div className="d-flex justify-content-center">
                        <div className="col-md-12 text-white ">

                            <button className='btn btn-sm btn-outline-danger ' onClick={() => close()}><i className='fa-solid fa-x' /></button>
                                            ...
                                            <div className='card-body'>
                                                <div className="center text-white text-center ">
                                                    ...
                                                    <p className="mt-3">
                                                        ...
                                                        <span style={{ color: "#3EB8B4" }}>{`${6500 + remainingUsers}`} </span>/10000 registers left.{" "}
                                                    </p>
                                                </div>
                                            </div>
                                        </>
                            ...
                            <div className="d-flex justify-content-center">
                                ...
                                <button
                                    className="btn btn-outline-primary text-white btn-lg mt-2"
                                    onClick={onNext}
                                >
