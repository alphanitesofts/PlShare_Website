...
const Register = ({ shouldShow, close }) => {
            ...
            <Modal open={shouldShow} >
                <div className='card-body'>
                    <div className='d-flex'>
                        ...
                        <button className='btn btn-outline-danger btn-sm ms-auto mt-1'>X</button>
                    </div>
                    ...
                    <div className='d-flex  me-3'>
                        <button id="emailHelp" className="form-text mt-3" >You can Sign in from Top</button>
