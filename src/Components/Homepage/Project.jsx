            ...
            <div>
                ...
                <div className='row mt-5 mb-5 m-5' id='stock'>
                    ...
                    <div className='col-lg-5' style={{ position: 'relative' }}>
                        <img src={graphs} className='img-fluid ' style={{ marginTop: '100px', borderRadius: '10px' }} alt="" />
                    </div>
                </div>

                <div className='row mt-4 mb-5 m-5' id='realEstate'>
                    <div className='col-lg-5' style={{ position: 'relative' }}>
                        <img src={build} className=' img-fluid' style={{ borderRadius: '10px' }} alt="" />
                    </div>
                    <div className='col-lg-7'>
                ...
                <div className='row mt-5 mb-5 m-5' id='crops'>
                    <div className='col-lg-8'>
                        ...
                        <p className='textDemo'>PL Share invests in crops for high yields. Mainly investing in technology-related farms such as Greenhouse farming, can be accomplished using multiple types of structures, depending on the goal and needs of the farming operations. They vary depending on the system, the material used to cover them and the construction technique. <br />
                            ...
                            ◯ Easier pest management and good protection from destructive animals like deer or rabbits. <br />
                            ◯ Supports growing high-value crops and hard-to-find plant species. <br />
                    ...
                    <div className='col-lg-4' style={{ position: 'relative' }}>
                        <img src={agriculture} style={{ borderRadius: '10px' }} className='img-fluid' alt="" />
                    </div>
                </div>

                <div className='row mt-5 mb-5 m-5'>
                    <div className='col-lg-4' style={{ position: 'relative' }}>
                        <img src={coins} className='img-fluid' style={{ borderRadius: '10px' }} alt="" />
                    </div>
                    <div className='col-lg-8'>
                        ...
                        <p className='textDemo'>For the first time the term "cryptocurrency" appeared in 2009, due to the appearance of the payment system "bitcoin", developed until now unknown man or maybe even a group of people under the pseudonym Satoshi Nakamoto (Eng. Satoshi Nakamoto). <br />
                            ...
                            2013 became fatal for bitcoin. At the beginning of the year it was breaking the mark of $ 31 for 1 bitcoin, just after 2 months’ rod has risen to $ 100, and by the end of the year the course was already unbelievable $ 1200 per electronic coin! <br />
