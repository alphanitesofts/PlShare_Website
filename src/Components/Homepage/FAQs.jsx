                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-8 col-lg-6 text-center mb-3">
                            <h6 className="fw-bold fs-4 display-3 lh-sm mb-5 text-primary">Frequently asked questions</h6>
                        </div>
                    </div>
                            ...
                            <div className="accordion" id="accordionExample" >
                                <div className="accordion-item border-top">
                                    <h2 className="accordion-header" id="heading1">
                                        <button className="accordion-button px-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1"><span className="mb-0 fw-bold text-start fs-1 text-1000 text-white" >Why should I use the app?</span></button>
                                    </h2>
                                ...
                                <div className="accordion-item border-top">
                                    <h2 className="accordion-header" id="heading2">
                                        <button className="accordion-button px-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="true" aria-controls="collapse2"><span className="mb-0 fw-bold text-start fs-1 text-1000 text-white">Where our money is invested?</span></button>
                                    </h2>
                                ...
                                <div className="accordion-item border-top">
                                    <h2 className="accordion-header" id="heading3">
                                        <button className="accordion-button px-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="true" aria-controls="collapse3"><span className="mb-0 fw-bold text-start fs-1 text-1000 text-white">How can I deposit and Withdraw my amount?</span></button>
                                    </h2>
                                ...
                                <div className="accordion-item border-top">
                                    <h2 className="accordion-header" id="heading6">
                                        <button className="accordion-button px-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="true" aria-controls="collapse6"><span className="mb-0 fw-bold text-start fs-1 text-1000 text-white">Is this app secure to invest?</span></button>
                                    </h2>
                                ...
                                <div className="accordion-item border-top">
                                    <h2 className="accordion-header" id="heading7">
                                        <button className="accordion-button px-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse7" aria-expanded="true" aria-controls="collapse7"><span className="mb-0 fw-bold text-start fs-1 text-1000 text-white">Is my investment secure?</span></button>
                                    </h2>
