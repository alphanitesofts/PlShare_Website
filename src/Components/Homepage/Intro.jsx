    ...
    <div className="container">
      <div className="row align-items-center g-2">
        ...
        <div className="col-md-7 col-lg-6 py-6 text-md-start text-center">
          ...
          <p className="mb-5 fs-1 fw-medium">Crafted with care &amp; creativity. Brings together <br className="d-none d-xl-block" />everthing in one place.</p><a className="btn hover-top btn-collab" href="#!"><i className="fas fa-download me-2" /> DOWNLOAD</a><a className="btn hover-top btn-collab-outline text-gradient ms-2" href="#!"> <i className="fas fa-play text-danger me-md-2 me-0" /> CHECK DEMO</a>
        </div>
      </div>
    </div>
  </section>
