                ...
                <div className="container p-5">
                    <div className="row">
                        <div className="col-lg-4 col-md-12 mb-4">
                            <div className="cardx h-100 shadow-lg">
                                <div className="cardx-body">
                                    ...
                                    <p className="cardx-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                </div>
                                ...
                                <div className="cardx-body text-center">
                                    <button className="btn btn-outline-primary btn-lg" style={{ borderRadius: 30 }}>Select</button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-12 mb-4">
                            <div className="cardx h-100 shadow-lg">
                                <div className="cardx-body">
                                    <div className="text-center p-3">
                                        <h5 className="cardx-title">Standard</h5>
                        ...
                        <div className="col-lg-4 col-md-12 mb-4">
                            <div className="cardx h-100 shadow-lg">
                                <div className="cardx-body">
                                    <div className="text-center p-3">
                                        <h5 className="cardx-title">Premium</h5>
