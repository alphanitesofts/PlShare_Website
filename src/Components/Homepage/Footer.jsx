                ...
                <div className="container">
                    ...
                    <div className="row justify-content-md-between justify-content-evenly py-3">
                        <div className="col-12 col-sm-8 col-md-6 col-lg-auto text-center text-md-start">
                            <p className="fs-0 my-2 text-400">All rights Reserved <span className="fw-bold text-500">© Your Company, 2021</span></p>
                        </div>
                        <div className="col-12 col-sm-8 col-md-6">
                            <p className="text-center text-md-end text-400"> Made with&nbsp;
                                ...
                                </svg>&nbsp;by&nbsp;<a className="fw-bold text-500" href="https://themewagon.com/" target="_blank">ThemeWagon </a>
                            </p>
                        </div>
                    </div>
                </div>
